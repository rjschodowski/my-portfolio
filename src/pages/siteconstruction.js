...
export default function SiteConstruction() {
  ...
  return (
    <Layout>
      <SEO title="SiteConstruction" />
      <h1 className={heading}>Page Updating</h1>
      <div className={contactContainer}>
        <div className={contactLayout}>
          <div className={contactSocial}>
            <div className={contactText}>
              <p>I'm currently updating this project's page, but in the meantime, feel free to connect with me on social media or via the contact form.</p>
            </div>
